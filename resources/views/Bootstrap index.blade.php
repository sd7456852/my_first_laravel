...
@section('nav')
    <div class="container-xxl d-flex">
        <div class="col d-flex align-items-center px-5">
            <img src={{asset('./img/logo.svg')}} alt="" width="106px" height="60px">
        </div>
        <div class="col box1 d-flex align-items-center justify-content-end px-5 ">
            <a href="">Blog</a>
            <a href="">Portfolio</a>
            <a href="">About</a>
            <a href="">Contact</a>
...
@section('main')
        ...
        <div class="container-xxl py-5 px-5">
            ...
            <div class="row d-flex text-center">
                <div class="card" style="width: 33.33%;">
                    <div class="img">
                        <img src={{asset('./img/pulse.png')}} class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                ...
                <div class="card" style="width: 33.33%;">
                    <div class="img">
                        <img src={{asset('./img/scissors.png')}} class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
    ...
    <section id="master">
        <div class="container-xxl p-5">
            ...
            <div class="row">
                <div class="row" style="width: 50%;">
                    <img src={{asset('./img/500x300.png')}} alt="" width="50%" height="178" style="border: 3px solid;color: white;">
                    <img src={{asset('./img/500x300.png')}} alt="" width="50%" height="178" style="border: 3px solid;color: white;">
                    <img src={{asset('./img/500x300.png')}} alt="" width="100%" height="365" style="border: 3px solid;color: white;">
                </div>
                <div class="row" style="width: 50%;">
                    <img src={{asset('./img/500x300.png')}} alt="" width="100%" height="365" style="border: 3px solid;color: white;">
                    <img src={{asset('./img/500x300.png')}} alt="" width="50%" height="178" style="border: 3px solid;color: white;">
            ...
            <div class="row justify-content-center border-bottom">
                <div class="row-4">
                    <div class="bg d-flex justify-content-center align-self-center">
                        <img src={{asset('./img/activity.svg')}} alt="" width="30px" height="30px">
                    </div>
                </div>
        ...
        <div class="container-xxl">
            <div class="row d-flex flex-column flex-md-row">
                <div class="col-12 col-md-6 h-auto ">
                    <img src={{asset('./img/400x400.png')}} alt="" class="merch_pic h-auto">
                </div>
...
@section('footer')
    <section id="sitemap">
        <div class="container-fluid">
            <div class="row ">
                <div class="col">
                    <img src={{asset('./img/logo.svg')}} alt="" width="100px" height="100px">
                    <span>數位方塊</span>
